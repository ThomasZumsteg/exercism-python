...
class VerseTest(unittest.TestCase):
    ...
    def test_first_verse(self):
        first = 'This is the house that Jack built.'
        self.assertEqual(first, verse(1))

    def test_second_verse(self):
        second = 'This is the malt\n'\
                 'that lay in the house that Jack built.'
        self.assertEqual(second, verse(2))

    def test_last_verse(self):
        last = 'This is the horse and the hound and the horn\n'\
               'that belonged to the farmer sowing his corn\n'\
               'that kept the rooster that crowed in the morn\n'\
               'that woke the priest all shaven and shorn\n'\
               'that married the man all tattered and torn\n'\
               ...
               'that ate the malt\n'\
               'that lay in the house that Jack built.'
        self.assertEqual(last, verse(12))
